            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                        	<div class="col-lg-6 ">
                        		<img class="me" src="Ora.jpeg" height="150">
                        	</div>
                                    ...
                                    <form class="user" method="post" enctype="multipart/form-data" action="recup.php">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user"name="nom_ut"
                                                placeholder="Nom d'utilisateur..." required="required" autocomplete="off">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Mot de passe" name="password" required="required" autocomplete="off">
                                        </div>
                                         <div class="form-group">
